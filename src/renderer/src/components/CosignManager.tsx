            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="md:col-span-2">
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. docker.io/library/nginx:latest, ghcr.io/org/app:v1, fra.ocir.io/tenancy/repo:tag"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="md:col-span-2">
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. docker.io/myorg/myapp:v1.0.0, fra.ocir.io/mytenancy/myrepo:tag"
                  value={signImageRef}
